        ...
        <section id="info-section" className="py-[100px] px-[18px] bg-white">
          <div id="overlay" className="flex flex-col lg:flex-row opacity-0">
            ...
            <div id="text" className="w-full lg:w-2/3 text-2xl md:text-3xl">
              <h1 className="mb-10">
                At Azerbaijan Gallery, we bring the world of automotive
                excellence to your fingertips. Whether you&apos;re a car
                enthusiast, a collector, or simply someone who appreciates the
                beauty of finely crafted vehicles, our gallery is your gateway
                to a stunning collection of cars from every era and style.
              </h1>
              <h1 className="mb-10">
              ...
              <h1>
                Step into the future with our exclusive collection of modern
                cars. These vehicles represent the pinnacle of automotive
                technology, combining cutting-edge performance with breathtaking
                aesthetics. From electric vehicles (EVs) that redefine
                sustainability to high-performance supercars that push the
                limits of speed, our modern car gallery showcases the best of
                what today&apos;s automotive industry has to offer.
              </h1>
            </div>
          </div>
        </section>
                      ...
                      >
                        <div className=" border-b-1 pb-4 flex items-center justify-between ">
                          <div className="truncate flex text-nowrap">
                            ...
                            <h1 className=" text-black  text-md lg:text-2xl font-extralight mr-5">
                              {data.modelName}
                            </h1>
                            <div className="text-black  text-md lg:text-2xl font-extralight">
                              ({data.brand})
                            </div>
                          </div>
                          <FaArrowLeft
